...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="//kit-pro.fontawesome.com/releases/v6.2.0/css/pro.min.css">
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="#"><i class="fad fa-home fa-fw me-1"></i> Home</a></li>
                <li class="menu-item hidden"><a href="<?= site_url('profile') ?>"><i class="fad fa-user fa-fw me-1"></i> Profile</a></li>
            </ul>
        </div>
