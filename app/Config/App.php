...
class App extends BaseConfig
{
	 ...
	 * --------------------------------------------------------------------------
	 *
	 * This config provides value from Google OAuth2 services
	 * 
	...
	public $OAuth2Config = [
		"clientId" => "557597540359-ik8m686dfj4eg7mqokbae775cbn1s0cs.apps.googleusercontent.com",
		"clientSecret" => "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",
		"redirectUri" => "oauth"
	];
}
